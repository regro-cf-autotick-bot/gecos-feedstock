...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/gecos-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14757&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/gecos-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `gecos` can be installed with:

```
conda install gecos
```

It is possible to list all of the versions of `gecos` available on your platform with:
